      ...
      <section className="lg:h-[700px] py-[88px] px-3 mb-6 bg-cover bg-bottom bg-no-repeat bg-image-fundo-servicos">
        ...
        <div className="mt-[76px] mb-[90px] grid xm:grid-cols-2 wrapper gap-8 md:gap-4">
            <motion.div initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.1 }}>
              <Link href="/servicos/acompanhamento-de-obras" className=" hover:bg-black/10 transition-colors rounded-md p-3 flex gap-6 items-center flex-col justify-center ss:flex-row ss:justify-start space-y-3.5 text-white text-center max-w-[493px] mx-auto">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.4 }}>
